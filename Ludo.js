...
export class Ludo {
    ...
    resetGame() {
        ...
        UI.removeWinnerMessage(); // Clear winner message when resetting
    }
        ...
        const interval = setInterval(() => {
            ...
            if (moveBy === 0) {
                ...
                if (this.hasPlayerWon(player)) {
                    UI.showWinner(player); // Show winner message
                    return;
                }
    ...
    hasPlayerWon(player) {
        const isWinner = [0, 1, 2, 3].every(piece => this.currentPositions[player][piece] === HOME_POSITIONS[player]);
        if (isWinner) {
            UI.showWinner(player); // Show winner message
        }
        return isWinner;
